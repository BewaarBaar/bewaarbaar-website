...
const products = [
  ...
  {
    slug: 'basisschool-bewaarmap-digitaal',
    name: 'De Grote Basisschool Bewaarmap — Digitaal Drukbestand',
    subtitle: 'PDF drukbestand — zelf printen & inbinden',
    price: '€12,50',
    image: mapVoorkant,
    hoverImage: mapInhoud,
    gallery: [mapVoorkant, mapInhoud, mapKnutsel, mapIK, mapAchterkant],
    ...
    sections: [
      {
        title: 'Wat zit er in het bestand?',
        intro: 'Het PDF drukbestand bevat exact dezelfde pagina\'s als de fysieke map:',
        items: [
          'Alle 8 secties — één per groep',
          'Invulpagina\'s per schooljaar',
          'Foto-hoesjes voor schoolfoto\'s',
          'Ruimte voor tekeningen, knutselwerkjes en rapporten',
          'Speelse illustraties per leeftijd',
        ],
      },
      {
        title: 'Technische specificaties',
        text: 'Formaat: A4 (210 × 297 mm)\nResolutie: 300 dpi — geschikt voor professioneel drukken\nBestandstype: PDF\nKleur: volledig kleur (CMYK)',
      },
      {
        title: 'Printen & inbinden',
        text: 'Laat het bestand printen bij een copyshop (bijv. Staples, Ricoh of een lokale drukker). Kies voor 200 grams papier voor de beste kwaliteit. Laat de pagina\'s inbinden met een ringband of spiraalband op A4-formaat.',
      },
    ],
    closingText: 'Hetzelfde mooie ontwerp. Zelf printen, zelf inbinden.\nPerfect als je snel wilt beginnen of de map als cadeau wilt meegeven.',
    features: [
      'Volledige PDF — direct na betaling beschikbaar',
      'Printresolutie 300 dpi — geschikt voor copyshop',
      'A4-formaat, volledig kleur',
      'Alle 8 groepen inbegrepen',
      'Eenmalig gebruik — voor persoonlijk gebruik',
      'Geen verzendkosten',
    ],
    shippingLines: [
      '📥 Directe download na betaling',
      '📄 PDF — 300 dpi, A4, volledig kleur',
      '🖨️ Zelf printen bij copyshop of thuis',
    ],
    metaTitle: 'Basisschool Bewaarmap Digitaal Drukbestand — PDF Download | Bewaarbaar',
    metaDescription: 'Download het digitale drukbestand van de Grote Basisschool Bewaarmap. PDF op 300 dpi, direct beschikbaar na betaling. Zelf printen & inbinden. €12,50.',
  },
  {
